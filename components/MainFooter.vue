<template>
  <footer 
    ...
    <section 
      ...
      <div class="xs-full s-half horizontal">
        ...
        <div class="m-half footer-col v-margin-bottom-small">
          ...
          <p class="no-margin-top">Our studios sit on country of the Gadigal people of the Eora nation in Sydney and the Ngunnawal people in Canberra.
          </p>
    ...
    <section class="inverse v-padded">
